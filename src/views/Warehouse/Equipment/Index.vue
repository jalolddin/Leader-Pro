<template>
  <section class="pb-20">
    <div class="pt-10 pb-8 wrapper">
      ...
      <span class="text-sm text-[#888A8F] mt-2">100 шт</span>
    </div>
    <div
    ...
    <div class="a-table">
      <div class="table-1" v-if="currantTable === 'table-1'">
        <div class="wrapper border-b-[1.5px] borderBox pb-10">
          ...
          <div class="a-table-body">
            ...
            >
              ...
              <li class="uk-width-expand">
                <h3 class="a-table-text green-color">{{ 5000 * item }} {{$i18n.locale == 'ru' ? ' сум' : ' so`m'}}</h3>
              </li>
              <li class="uk-width-expand">
                <h3 class="a-table-text green-color">{{ 5000 * 99 * item }} {{$i18n.locale == 'ru' ? ' сум' : ' so`m'}}</h3>
              </li>
                  ...
                  <div>
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{$t('equipment')}}</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Narvon</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{ item }}0,000 tal</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
                    ...
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Zanjir {{ item }}</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{ item }}0,000 tal</h3>
                          </li>
                    ...
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Kesma 24 mm</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{ item + 1 }}0 ta</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
                    ...
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">
                              Ulatgich {{ item + 1 }},000 metr
                            </h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{ item }}00 ta</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
