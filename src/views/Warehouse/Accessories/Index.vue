        ...
        <div class="wrapper border-b-[1.5px] borderBox">
          ...
          <div class="a-table-body">
            ...
            >
              ...
              <li class="uk-width-expand">
                <h3 class="a-table-text warn-color">{{ 4 * item }} ta</h3>
              </li>
              <li class="uk-width-expand">
                <div class="relative">
                  <div
                    ...
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li>
                            <h3 class="a-table-text">Bisvol 2{{ item }}DT</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">{{ item }}0,000 ta</h3>
                          </li>
                          <li class="w-[100px]">
                            <div class="relative">
                              <div
                    ...
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li>
                            <h3 class="a-table-text">Ximiya PPL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">{{ item }}0,000 ta</h3>
                          </li>
                    ...
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          ...
                          <li>
                            <h3 class="a-table-text">Ximiya KL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">{{ item }}0,000 ta</h3>
                          </li>
