<template>
  <section class="pb-20">
        ...
        <div class="wrapper border-b-[1.5px] borderBox">
          ...
          <div class="a-table-body">
            ...
            >
              ...
              <li class="uk-width-expand">
                <h3 class="a-table-text main-color-black">Gubka</h3>
              </li>
              <li class="uk-width-expand">
                  ...
                  <div>
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li>
                            <h3 class="a-table-text">Gubka CL</h3>
                          </li>
                          <li>
                  ...
                  <div>
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li>
                            <h3 class="a-table-text">Gubka vL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">Porolom {{item + 1}}2 talik</h3>
                          </li>
                          <li>
                  ...
                  <div>
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li>
                            <h3 class="a-table-text">Gubka DL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">Gubka {{item}}0 DD</h3>
                          </li>
                          <li>
                  ...
                  <div>
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li>
                            <h3 class="a-table-text">Gubka fL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">Gubka 3{{item}} QL</h3>
                          </li>
                          <li>
                            <h3 class="a-table-text">{{item * 10}},0 ta</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
    ...
    <spongeModal :isModalActive="isModalActive"/>
