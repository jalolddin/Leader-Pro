<template>
  <section class="pb-20">
        ...
        <div class="wrapper border-b-[1.5px] borderBox">
          ...
          <div class="a-table-body">
            ...
            >
              ...
              <li class="uk-width-expand">
                <h3 class="a-table-text main-color-black">Matras</h3>
              </li>
              <li class="uk-width-expand">
                  ...
                  <div>
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Matras KLP</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Yumshoq 1{{item}} DP</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{item}},6 ta</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
                  ...
                  <div>
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Matras LK</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Detskiy {{item + 1}} DD</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">{{item * 20}},0 ta</h3>
                          </li>
                          <li class="uk-width-expand relative">
                            <div
                              @click="togglePopup(index)"
                  ...
                  <div>
                    <div class="border-r-[1.5px] borderBox pr-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Matras LLP</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Yumshoq 1{{item}} DP</h3>
                          </li>
                  ...
                  <div>
                    <div class="pl-10">
                      ...
                      <div class="a-card-body">
                        ...
                        >
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Matras QL</h3>
                          </li>
                          <li class="uk-width-expand">
                            <h3 class="a-table-text">Ortopedik {{item * 20}}</h3>
                          </li>
                          <li class="uk-width-expand">
    ...
    <mattressModal :isModalActive="isModalActive"/>
